...
model.sub_models[0].ghost_train_adam(C[id_tr,:], d11_DiagMamtano[id_tr,:], niteration=6000, lr=0.0002)
...
model.train_adam(C[id_tr,:], DuDx[id_tr,:], intC[id_tr,:], 20000, lr=0.0002)
model.train_adam(C[id_tr,:], DuDx[id_tr,:], intC[id_tr,:], 20000, lr=0.0002)
